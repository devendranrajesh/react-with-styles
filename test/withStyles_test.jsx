...
describe('withStyles()', () => {
  ...
  beforeEach(() => {
    ...
    testInterfaceResolveLTRStub = sinon.stub(testInterface, 'resolveLTR').callsFake(fakeResolveMethod);
    testInterfaceResolveRTLStub = sinon.stub(testInterface, 'resolveRTL').callsFake(fakeResolveMethod);
